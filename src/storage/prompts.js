...
const DEFAULT_PROMPTS = [
  {
    ...
    template:
      "Translate the following text to English. Output ONLY the translation, no explanations or notes.\n\n{text}",
  ...
  },
  {
    ...
    template:
      "Translate the following text to {language}. Output ONLY the translation, no explanations or notes.\n\n{text}",
    showInContextMenu: true,
  },
  {
    ...
    template:
      "Correct the grammar and fix typos in the following text. Output ONLY the corrected text, no explanations or notes.\n\n{text}",
    showInContextMenu: true,
  },
  {
    ...
    template:
      "Rewrite the following text in a professional tone. Output ONLY the rewritten text, no explanations or notes.\n\n{text}",
    showInContextMenu: true,
  },
  {
    id: "default-simplify",
    name: "Simplify",
    template:
      "Rewrite the following text in simpler English. Output ONLY the simplified text, no explanations or notes.\n\n{text}",
    showInContextMenu: true,
  },
];
